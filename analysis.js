...
try { const savedTheme = localStorage.getItem('relay-board-theme'); if (['dark', 'light', 'ivory'].includes(savedTheme)) document.documentElement.dataset.theme = savedTheme; } catch {}
load();
