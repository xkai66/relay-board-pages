...
try { const savedTheme = localStorage.getItem('relay-board-theme-v2'); if (savedTheme === 'dark' || savedTheme === 'ivory') document.documentElement.dataset.theme = savedTheme; } catch {}
load();
