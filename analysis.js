...
try { const savedTheme = localStorage.getItem('relay-board-theme'); if (savedTheme === 'dark' || savedTheme === 'light' || savedTheme === 'ivory') document.documentElement.dataset.theme = savedTheme === 'ivory' ? 'light' : savedTheme; } catch {}
load();
