...
try { const savedTheme = localStorage.getItem('relay-board-theme-v3'); if (savedTheme === 'dark' || savedTheme === 'ivory') document.documentElement.dataset.theme = savedTheme; } catch {}
load();
